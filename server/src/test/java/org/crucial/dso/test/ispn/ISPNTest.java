package org.crucial.dso.test.ispn;

import org.crucial.dso.test.BaseTest;
...
public abstract class ISPNTest extends BaseTest {
   ...
   public void testElasticity() throws ExecutionException, InterruptedException {
      ...
      ExercisePutTask putTask = new ExercisePutTask(
              map,container(0).getCache(DSO_CACHE_NAME));
      ...
      for (int k : map.keySet()) {
         assert container(0).getCache(DSO_CACHE_NAME).containsKey(k);
      }
