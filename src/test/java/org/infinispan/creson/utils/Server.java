...
public class Server {
   ...
   public void doMain(String[] args) {
      ...
      gbuilder.transport().addProperty("configurationFile", "jgroups-creson.xml");
      ...
      if (maxEntries!=Long.MAX_VALUE) {
         ...
         storeConfigurationBuilder.location(System.getProperty("store-creson-server" + host));
      ...
      SignalHandler sh = new SignalHandler() {
         ...
         public void handle(Signal s) {
            ...
            try {
               Factory factory = Factory.forCache(cm.getCache());
               if (factory != null)
                  factory.close();
               server.stop();
               cm.stop();
